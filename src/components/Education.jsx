    ...
    <div className="mx-auto my-10 lg:w-[65%] md:px-0 px-4" id="education">
      <h1 className='text-4xl font-bold mb-10 text-center font-poppins text-[#3b82f6]'>Education</h1>
        ...
        <div className='flex gap-14 flex-col w-full relative lg:w-[80%] mx-auto'>
          ...
          <div className="left justify-end md:justify-start flex w-full">

            <div className='border w-[95%] md:w-md border-gray-500 p-5 relative before:content-[""] before:absolute before:top-5 md:before:-right-12 md:before:w-12 before:h-0.5 before:w-4 before:-left-4 before:bg-blue-400'
           ...
           <div className='absolute md:left-1/2 left-0 top-0 h-full w-1 bg-gray-700' />

          <div className="right justify-end flex w-full">
            <div className='border relative border-gray-500 p-5 w-[95%] md:w-md before:content-[""] before:absolute before:top-5 md:before:-left-12 md:before:w-12 before:w-4 before:-left-4 before:h-0.5 before:bg-blue-400'>
