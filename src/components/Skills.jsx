...
const Skills = () => {
  return (
    <div className='lg:w-[65%] mx-auto my-10 overflow-x-hidden overflow-y-hidden' id='skills'>
        <h1 className='text-4xl font-bold mb-10 text-center font-poppins text-[#3b82f6]'>Skills</h1>
        <div className='grid lg:grid-cols-3 gap-8 md:grid-cols-2 grid-cols-1 lg:px-0 px-4'>
